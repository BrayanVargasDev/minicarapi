...
class SchedulesService {
  ...
  async findOne(id) {
    ...
    const vehiclesByCustomerId = await this.getVehiclesByCustomerId(obj.customerId);
    obj.dataValues.vehicles = vehiclesByCustomerId;
  ...
  async getVehiclesByCustomerId(customerId) {
    const sequelize = models.Vehicle.sequelize;
    const query = `
      SELECT *
      FROM vehicles
      WHERE customer_id = :id
