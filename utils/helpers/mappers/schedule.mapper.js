...
function scheduleMapper(json) {
  ...
  return {
    ...
    services: services,
    occupiedTimes: (json && json.dataValues && json.dataValues.occupiedTimes) ? json.dataValues.occupiedTimes : [],
    vehicles: (json && json.dataValues && json.dataValues.vehicles) ? json.dataValues.vehicles : [],
  }
}
